...
# %% ¤¤¤¤ Linear Regression: Ejection Fraction ¤¤¤¤
...
fit_table.to_csv("../../output/tabular-modeling/fit_info_LVEF_regression.csv")
...
fit_table.to_csv("../../output/tabular-modeling/fit_info_LVEF_regression_RNNscores.csv")
